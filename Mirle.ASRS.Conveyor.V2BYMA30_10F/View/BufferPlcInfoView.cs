            ...
            try
            {
                if (conveyorController.IsConnected)
                {
                    if (comboBoxBufferIndex.SelectedIndex != -1)
                    {
                        ...
                        lblEmptyQty.Text = conveyorController.GetBuffer(StnIdx).CallEmptyQty.ToString();
                        /*
                        for (int i = 0; i < 16; i++)
                        {
                        ...
                        */
                        ...
                        lblCallEmpty_PC.Text = conveyorController.GetBuffer(StnIdx).CallEmptyQty_PC.ToString();
                        ...
                        lblCallEmptyReport.Text = conveyorController.GetBuffer(StnIdx).CallEmpty.ToString();
        ...
        private void btnInitial_PcToPlc_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                    ...
                    conveyorController.IsConnected)
                {
                    ...
                    conveyorController.GetBuffer(StnIdx).WriteCallEmptyReport(0);
