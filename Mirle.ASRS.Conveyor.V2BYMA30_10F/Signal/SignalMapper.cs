...
namespace Mirle.ASRS.Conveyor.V2BYMA30_10F.Signal
{
    public class SignalMapper
    {
        ...
        private void MappingConveyor()
        {
            ...
            _Signal.OpcData = new WordBlock(_mplc, $"D{addr + 1}", 4010);
        ...
        private void MappingBuffer()
        {
            ...
            for (int i = 1; i <= BufferCount; i++)
            {
                ...
                bufferSignal.CallEmptyQty = new Word(_mplc, $"D{startAddress + offset + 8}");
                ...
                bufferSignal.Controller.CallEmptyQty = new Word(_mplc, $"D{controllerStartAddress + offset + 8}");
