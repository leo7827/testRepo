...
{
    public class CarrierInstallCompletedEventArgs : EventArgs
    {
        public CarrierInstallCompletedEventArgs(string carrierID, string carrierLoc, string carrierZoneName)
        {
