...
{
    public class TransferAbortCompletedEventArgs : EventArgs
    {
        public TransferAbortCompletedEventArgs(Stocker.TaskControl.Info.UpdateCommandInfo transfer, string carrierLoc)
        {
