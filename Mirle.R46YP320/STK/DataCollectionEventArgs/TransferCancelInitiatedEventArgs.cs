...
{
    public class TransferCancelInitiatedEventArgs : EventArgs
    {
        public TransferCancelInitiatedEventArgs(Stocker.TaskControl.Info.UpdateCommandInfo transfer, string carrierLoc)
        {
