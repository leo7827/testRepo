...
{
    public class TransferAbortFailedEventArgs : EventArgs
    {
        public TransferAbortFailedEventArgs(Stocker.TaskControl.Info.UpdateCommandInfo transfer, string carrierLoc)
        {
