...
{
    public class TransferCancelFailedEventArgs : EventArgs
    {
        public TransferCancelFailedEventArgs(Stocker.TaskControl.Info.UpdateCommandInfo transfer, string carrierLoc)
        {
