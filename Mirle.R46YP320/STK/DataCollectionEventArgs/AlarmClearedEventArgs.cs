...
namespace Mirle.R46YP320.STK.DataCollectionEventArgs
{
    ...
    {
        public AlarmClearedEventArgs(Stocker.TaskControl.Info.UpdateCommandInfo transfer, string carrierLoc, string errorID, string StockerUnitID, VIDEnums.StockerUnitState StockerUnitState, int AlarmID)
        {
