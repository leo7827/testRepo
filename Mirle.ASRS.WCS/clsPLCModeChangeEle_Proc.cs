...
{
    public class clsPLCModeChangeEle_Proc
    {
        private System.Timers.Timer timRead = new System.Timers.Timer();
        public clsPLCModeChangeEle_Proc()
        {
        ...
        private void timRead_Elapsed(object source, System.Timers.ElapsedEventArgs e)
        {
            ...
            try
            {
                int iModeStatus = clsLiteOnCV.GetConveyorController_Elevator().Signal.ModeStatus.GetValue();
                int iModeStatus_PC = clsLiteOnCV.GetConveyorController_Elevator().Signal.Controller.ModeChange.GetValue();
