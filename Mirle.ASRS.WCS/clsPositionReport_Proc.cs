...
{
    public class clsPositionReport_Proc
    {
        private System.Timers.Timer timRead = new System.Timers.Timer();
        public clsPositionReport_Proc()
        {
        ...
        private void timRead_Elapsed(object source, System.Timers.ElapsedEventArgs e)
        {
            ...
            try
            {
                int CvIdxTotal = clsLiteOnCV.GetConveyorController_Elevator().BufferCount;
                ...
                for (int i = 0; i < CvIdxTotal; i++)
                {
                    if (clsLiteOnCV.GetConveyorController_Elevator().IsConnected)
                    {
                        ...
                        {
                            //bcr 處不要上報 position 
                            0 => ConveyorDef.LI1_01,
                            1 => ConveyorDef.LI1_02,
                            2 => ConveyorDef.LI1_03,

                            _ => ConveyorDef.LI1_04,                          

                        };

                        var cv = clsLiteOnCV.GetConveyorController_Elevator().GetBuffer(buffer.Index);
