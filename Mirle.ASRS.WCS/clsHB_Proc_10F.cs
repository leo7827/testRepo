    ...
    public class clsHB_Proc_10F
    {
        ...
        private void timRead_Elapsed(object source, System.Timers.ElapsedEventArgs e)
        {
            ...
            try
            {
                ...
                if (!clsLiteOnCV.GetConveyorController_10F().IsConnected && !bFlag_Happen)
                {
                    ...
                    {
                        jobId = "123",
                        deviceId = clsConstValue.deviceID.E04_10F,
                ...
                if (clsLiteOnCV.GetConveyorController_10F().IsConnected && !bFlag_Clear)
                {
                    //呼叫API
                    ALARM_HAPPEN_REPORTInfo alarmReportInfo = new ALARM_HAPPEN_REPORTInfo()
                    {
